(function (window) {
    ...
    opspark.preload = function (game) {
        ...
        game.load.image('db', './asset/collectable/Dragon1.png');
        game.load.image('steve', './asset/collectable/Dragon2.png');
        game.load.image('grace', './asset/collectable/grace-head.png');
        game.load.image('kennedi', './asset/collectable/kennedi-head.png');
        game.load.image('max', './asset/collectable/greenDragon.png');
